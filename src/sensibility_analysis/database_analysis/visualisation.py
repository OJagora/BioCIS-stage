...
def delta_heatmap(X, n = 100, p = 11):
    '''
    delta_heatmap plots the heatmap of the deltas for each case test
    
    :param numpy array X: array of values
    :param int n: number of points
    :param int p: number of ticks
    
    :return: heatmap of deltas
    '''
...
def plotWt(X,n = 1000, w = 10) :
    '''
    plotWt plots the rolling mean distribution of g in function of the value of wt

    :param numpy array X: array of values
    :param int n: number of points
    :param int w: window size

    :return: rolling mean distribution of g in function of the value of wt
    '''
...
def plotW(ax, X, W, p, n) :
    '''
    plotW plots the enveloppes of g in function of the value of W
    ...
    :return: enveloppes of g in function of the value of W
    '''
...
def visualize_weights_enveloppes(W = [0.1, 0.3, 0.5, 0.7, 0.9], n = 1000):
    '''
    visualize_weights_enveloppes plots the enveloppes of g in function of the value of W

    :param list W: list of weights
    :param int n: number of points
