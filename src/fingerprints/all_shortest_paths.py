...
def getASPfinger(mol, atom = -1, n = 1024) :
    ...
    :param rdkit.Chem.Mol mol: RDKit molecule to process
    :param int atom: index of the atom to supress for the calculation of the fingerprint. By default, this argument is set to -1,
    ...
    :param int n: number of bits used to code the fingerprint

    :return rdkit.DataStructs.cDataStructs.ExplicitBitVect: fingerprint in the form of a bit vector of size n"""
